        ...
        <div className="grid grid-cols-[auto_1fr] gap-3 items-end">
          <label className="block">
            ...
            <input
              ...
              className="mt-1.5 h-11 w-16 rounded-xl border border-ink-200 bg-white px-3 text-center text-[22px] outline-none focus:border-brand-500"
            />
          </label>
          <label className="block">
            ...
            <input
              ...
              className="mt-1.5 h-11 w-full rounded-xl border border-ink-200 bg-white px-3 text-[15px] outline-none focus:border-brand-500"
            />
          </label>
        </div>
      ...
      <div className="vault-y-3">
        <label className="block">
          ...
          <input
            ...
            inputMode="decimal"
            placeholder="0"
            className="mt-1.5 h-12 w-full rounded-xl border border-ink-200 bg-white px-3 text-[18px] font-semibold outline-none focus:border-brand-500 tabular-nums"
          />
        </label>
